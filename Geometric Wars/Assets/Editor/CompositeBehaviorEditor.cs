...
public class CompositeBehaviorEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        else
        {
            ...
            EditorGUILayout.LabelField("Num", GUILayout.MinWidth(6f), GUILayout.MaxWidth(60f));
            ...
            {
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField("   " + (i + 1).ToString(), GUILayout.MinWidth(30f), GUILayout.MaxWidth(30f));
